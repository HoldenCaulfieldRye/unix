...
# Make terminal prompt (username@device name:currentDir) displayed grey
PS1='\[\033[0;37m\]\h:\W \u\$ \[\033[0m\]'
...
# make sure that bash shell looks for executables in the right directories 
...
# make sure that the python packages installed by python-pip have executables located on PATH
